...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { code: @currency.code, created_at: @currency.created_at, flag: @currency.flag, name: @currency.name, updated_at: @currency.updated_at } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { code: @currency.code, created_at: @currency.created_at, flag: @currency.flag, name: @currency.name, updated_at: @currency.updated_at } }
